                    ...
                    <div class="rvt-header-global__logo-slot">
                        <a class="rvt-lockup" href="/">
                            ...
                            <div class="rvt-lockup__body">
                                <span class="rvt-lockup__title">Teaching and Learning Technologies</span>
                    ...
                    <div class="rvt-header-global__controls">
                        ...
                        <div data-rvt-disclosure="menu" data-rvt-close-click-outside>
                            ...
                            <button aria-expanded="false"
                                ...
                                <svg class="rvt-global-toggle__open" xmlns="http://www.w3.org/2000/svg" width="16"
                                    height="16" fill="currentColor" viewBox="0 0 16 16">
                                    <path d="M15 4H1V2h14v2Zm0 5H1V7h14v2ZM1 14h14v-2H1v2Z" />
                                </svg>
                                <svg class="rvt-global-toggle__close" xmlns="http://www.w3.org/2000/svg" width="16"
                                    height="16" fill="currentColor" viewBox="0 0 16 16">
                                    <path
                            ...
                            <nav aria-label="Main" class="rvt-header-menu" data-rvt-disclosure-target="menu" hidden>
                                    ...
                                    <li class="rvt-header-menu__item">
                                        <div class="rvt-header-menu__dropdown rvt-dropdown"
                                            ...
                                            <div class="rvt-header-menu__group">
                                                ...
                                                <a class="rvt-header-menu__link" href="#">My classes</a>
                                                ...
                                                <button aria-expanded="false"
                                                    ...
                                                    <svg class="rvt-global-toggle__open"
                                            ...
                                            <div class="rvt-header-menu__submenu rvt-dropdown__menu rvt-dropdown__menu--right"
                                                data-rvt-dropdown-menu="primary-nav-1" hidden>
                                                <ul class="rvt-header-menu__submenu-list">
                                                    <!-- Dropdown links -->
                                                    <li class="rvt-header-menu__submenu-item">
                                                        <a class="rvt-header-menu__submenu-link" href="#">Sub Item
                                                            One</a>
                                                    </li>
                                                    <li class="rvt-header-menu__submenu-item">
                                                        <a class="rvt-header-menu__submenu-link" href="#">Sub Item
                                ...
                                <div
                                    class="rvt-flex rvt-items-center rvt-m-left-md rvt-p-bottom-md rvt-p-bottom-none-lg-up">
                                    <div class="rvt-avatar rvt-avatar--xs">
                                        <span class="rvt-avatar__text">{{ usernameLetter }}</span>
                                    </div>
...
@forward '/node_modules/rivet-core/sass/header-system/index.scss';
</style>